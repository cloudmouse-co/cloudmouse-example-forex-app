...
namespace ForexExample
{
    ...
    enum class ForexScreen
    {
        ...
        CONFIG_SAVED,  // Configuration updated, placeholder to show while recreating symbol list
    ...
    public:
        ...
        void scheduleSymbolListRecreate();
    ...
    private:
        ...
        lv_obj_t *screen_config_saved;
        lv_obj_t *screen_symbol_list;
        lv_obj_t *screen_symbol_detail;
        lv_obj_t *screen_loading;

        // CONFIG_SAVED screen elements
        lv_obj_t *spinner_config_saved;
        lv_obj_t *label_config_saved;
        ...
        void scheduleRecreateSymbolList();
